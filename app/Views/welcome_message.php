    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item"><a href="https://github.com/codeigniter4/CodeIgniter4/blob/master/CONTRIBUTING.md" target="_blank">Contribute</a></li>
                <li class="menu-item"><a href="https://forum.codeigniter.com/" target="_blank">Community</a></li>
                <li class="menu-item"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Docs</a></li>
